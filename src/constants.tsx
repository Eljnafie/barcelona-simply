  ...
  export const TRANSLATIONS: Record<Language, Translation> = {
    en: {
      ...
      hero: {
        ...
        subtitle: "The premier Arabic-speaking concierge in Barcelona. We provide specialized medical escort, administrative assistance, and VIP concierge for GCC visitors and Arabic-speaking families. Experience Barcelona with total peace of mind.",
      ...
      services: {
        items: {
          medical: { 
            ...
            summary: "Barcelona is a global hub for medical excellence. We provide a professional medical escort in Barcelona, bridging the gap between you and top hospitals (Teknon, Sant Joan de Déu, Barraquer). We manage appointments, provide medical translation, and ensure your comfort.",
          ...
          admin: { 
            ...
            summary: "Spanish bureaucracy is complex. We provide expert NIE and residency assistance in Spain. Whether you need a Golden Visa, or simply to open a bank account, our local experts handle the appointments and paperwork on your behalf.",
          ...
          study: { 
            ...
            summary: "Moving to Barcelona for studies? We offer comprehensive support for students coming to Barcelona from Saudi Arabia, Kuwait, Qatar, and beyond. We secure student visas, find safe housing, and navigate university registration.",
      ...
      services: {
        items: {
          medical: { 
            ...
            heroImage: "https://picsum.photos/1200/600?image=10",
            summary: "برشلونة وجهة عالمية للتميز الطبي. نحن نقدم خدمة مرافقة المستشفيات و المرافقة الطبية في برشلونة لضمان راحتك. نكون جسر التواصل بينك وبين أفضل المستشفيات (تيكنون، كيرون، باراكير). ندير المواعيد، نوفر الترجمة الطبية الفورية، ونضمن راحتك طوال رحلة العلاج.",
          ...
          admin: { 
            ...
            heroImage: "https://picsum.photos/1200/600?image=1068",
            summary: "البيروقراطية الإسبانية معقدة، لكننا نبسطها لك. نحن متخصصون في فيزا الإقامة و معاملات NIE. سواء كنت تحتاج الفيزا الذهبية، أو فتح حساب بنكي، خبراؤنا المحليون يديرون المواعيد والأوراق نيابة عنك.",
          ...
          study: { 
            ...
            heroImage: "https://picsum.photos/1200/600?image=101",
            summary: "هل تخطط من أجل الدراسة في برشلونة؟ نساعد الطلاب من السعودية، الكويت، قطر، وغيرها في تأمين فيزا الطالب، العثور على سكن آمن، وإتمام التسجيل الجامعي.",
          ...
          vip: { 
            ...
            heroImage: "https://picsum.photos/1200/600?image=1074",
            summary: "نقدم خدمات VIP حصرية لعملائنا الأكثر تميزاً. من السائقين الخاصين والحماية الشخصية إلى التسوق الحصري وإدارة الممتلكات، نضمن السرية والتميز.",
        ...
        posts: [
          ...
          },
          {
            ...
            content: {
              ...
              sections: [
                { title: 'ما هو NIE؟', content: 'رقم هوية الأجانب. تحتاجه لفتح حساب بنكي، شراء العقارات، أو قبول الميراث.' },
